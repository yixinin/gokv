...
import (
	...
	"github.com/yixinin/gokv/impls/stats"
	"github.com/yixinin/gokv/impls/types"
	"github.com/yixinin/gokv/impls/wal"
...
type raftNode struct {
	...
	getSnapshot func(context.Context) ([]byte, error)
...
func NewRaftNode(id int, peers []string, join bool, getSnapshot func(ctx context.Context) ([]byte, error), proposeC <-chan string,
...
func (rc *raftNode) maybeTriggerSnapshot(applyDoneC <-chan struct{}) {
	...
	data, err := rc.getSnapshot(context.Background())
	if err != nil {
		log.Panic(err)
	}
